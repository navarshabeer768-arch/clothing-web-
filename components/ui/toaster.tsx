        ...
        <AnimatePresence>
          {toasts.map(t => (
            <motion.div
              ...
              className={cn(
                'pointer-events-auto flex items-center gap-3 px-4 py-3.5 bg-white border shadow-luxury rounded-sm max-w-sm',
            ...
            >
              ...
              <button
                ...
                className="p-0.5 hover:bg-luxury-50 rounded-sm transition-colors flex-shrink-0"
              >
